            ...
            <CardContent className="p-0">
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(addToList)} className="space-y-6">
                        ...
                        <div className="flex w-full gap-2 pt-6 border-t border-gray-200 grid grid-cols-2">
                            <Button
                                type="submit"
                        ...
                        <div>
                            <Button
                                ...
                                variant="outline"
                                onClick={onSubmit}
                                className="h-11 w-full text-white bg-purple-600 hover:bg-purple-700 border-gray-300"
                            >
